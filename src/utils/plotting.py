...
path = r'/content/drive/MyDrive/srVAE'
...
def generate(model, n_samples, epoch=0, writer=None):
    ...
    if models_name == 'VAE':
        ...
        if writer:
            ...
            fname = path + r'/images/' + 'generated_images_' + str(epoch) + '.jpg'
        ...
        if writer:
            ...
            fname_x = path + r'/images/' + 'generated_images_x_' + str(epoch) + '.jpg'
            fname_y = path + r'/images/' + 'generated_images_y_' + str(epoch) + '.jpg'
            ...
            save_image(make_grid(nn.functional.interpolate(y, size=x.shape[2:]), nrow=n_rows, normalize=JPG_NORMALIZE), path+ r'/images/' + 're_generated_images_y_' + str(epoch) + '.jpg')
    else:
        pass
...
def reconstruction(model, dataloader, n_samples, epoch=0, writer=None):
    ...
    if models_name=='VAE':
        ...
        if writer:
            ...
            fname = path + r'/images/' + 'reconstructions_' + str(epoch) + '.jpg'
        ...
        if writer:
            ...
            fname_x = path + r'/images/' + 'reconstructed_images_x_' + str(epoch) + '.jpg'
            fname_y = path + r'/images/' + 'reconstructed_images_y_' + str(epoch) + '.jpg'
        ...
        if writer:
            ...
            fname = path + r'/images/' + 'super_res_' + str(epoch) + '.jpg'
...
def interpolation(model, dataloader, n_samples, epoch=0, writer=None):
    ...
    if models_name in ['VAE']:
        ...
        if writer:
            ...
            save_image(make_grid(x_hat, nrow=n_samples, normalize=JPG_NORMALIZE), path + r'images/image_interpolation.jpg')
    else:
        pass
