...
min_loss = None
def save_model(model, optimizer, loss, epoch, pth=PATH +r'/src/models/'):
    ...
    print('Saving At: ', r'/content/drive/MyDrive/srVAE/src/models/srvae' + r'/model.pth')
    torch.save(m.state_dict(), r'/content/drive/MyDrive/srVAE/src/models/srvae' + r'/model.pth')
